...
const BoxLoader3D = ({ backgroundColor = '#e5e7eb' }) => {
  const loaderCss = `
    .box-loader-3d {
      --duration: 3s;
      --primary: rgba(14, 165, 233, 1);
      --primary-light: rgba(56, 189, 248, 1);
      --primary-rgba: rgba(14, 165, 233, 0);
      width: 200px;
      height: 320px;
      position: relative;
    ...
    .box-loader-3d:before, .box-loader-3d:after {
      --r: 20.5deg;
      content: "";
      width: 320px;
      height: 140px;
    ...
    .box-loader-3d .ground div:before, .box-loader-3d .ground div:after {
      --rx: 90deg;
      --ry: 0deg;
      --x: 44px;
      --y: 162px;
    ...
    .box-loader-3d .ground div:after {
      --rx: 90deg;
      --ry: 90deg;
      --x: 0;
      --y: 177px;
    ...
    .box-loader-3d .box div:before, .box-loader-3d .box div:after {
      --rx: 90deg;
      --ry: 0deg;
      --z: 24px;
      --y: -24px;
    ...
    .box-loader-3d .box.box0 { --x: -220px; --y: -120px; left: 58px; top: 108px; animation-name: box-move0; }
    .box-loader-3d .box.box0 div { animation-name: box-scale0; }
    .box-loader-3d .box.box1 { --x: -260px; --y: 120px; left: 25px; top: 120px; animation-name: box-move1; }
    .box-loader-3d .box.box1 div { animation-name: box-scale1; }
    .box-loader-3d .box.box2 { --x: 120px; --y: -190px; left: 58px; top: 64px; animation-name: box-move2; }
    .box-loader-3d .box.box2 div { animation-name: box-scale2; }
    .box-loader-3d .box.box3 { --x: 280px; --y: -40px; left: 91px; top: 120px; animation-name: box-move3; }
    .box-loader-3d .box.box3 div { animation-name: box-scale3; }
    .box-loader-3d .box.box4 { --x: 60px; --y: 200px; left: 58px; top: 132px; animation-name: box-move4; }
    .box-loader-3d .box.box4 div { animation-name: box-scale4; }
    .box-loader-3d .box.box5 { --x: -220px; --y: -120px; left: 25px; top: 76px; animation-name: box-move5; }
    .box-loader-3d .box.box5 div { animation-name: box-scale5; }
    .box-loader-3d .box.box6 { --x: -260px; --y: 120px; left: 91px; top: 76px; animation-name: box-move6; }
    .box-loader-3d .box.box6 div { animation-name: box-scale6; }
    .box-loader-3d .box.box7 { --x: -240px; --y: 200px; left: 58px; top: 87px; animation-name: box-move7; }
    .box-loader-3d .box.box7 div { animation-name: box-scale7; }
